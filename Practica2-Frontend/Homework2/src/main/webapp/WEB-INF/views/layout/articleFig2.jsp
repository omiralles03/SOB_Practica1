<div class="overflow-hidden relative w-[700px] mx-auto bg-transparent">
        ...
        <!-- Row 3: Title and Topics -->
        <div class="px-6 py-2 flex justify-between items-center">
            <h2 class="text-2xl text-white font-bold">${article.title}</h2>
            <p class="text-sm text-gray-400">${article.topics}</p>
        </div>
          
        <!-- Row 4: Body -->
        <div class="px-6 py-2 flex justify-between items-center">
            <p class="text-md text-gray-400">${article.body}</p>
        </div>

        <!-- Row 5: Image (only if it exists) -->
